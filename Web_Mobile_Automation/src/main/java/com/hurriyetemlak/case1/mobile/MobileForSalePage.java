package com.hurriyetemlak.case1.mobile;
...
public class MobileForSalePage {
    ...
    */
	...
	@FindBy(xpath="/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/div[1]/section[5]/section/div")
	WebElement selectBuildingAgeBar;
	
	@FindBy(xpath="//*[contains(text(),'Sıfır Bina')]")
	WebElement selectBuildingAgeCheckBox;
	
	@FindBy(xpath="//*[@id=\"dropdown-lightbox-filter\"]/div[2]/ul/li[2]/label/span")
