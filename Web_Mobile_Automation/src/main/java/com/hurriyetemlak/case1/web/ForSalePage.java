package com.hurriyetemlak.case1.web;
...
public class ForSalePage {
	...
	@FindBy(xpath="//*[@id=\"listPage\"]/div[2]/div[2]/div/div[2]/div[1]/section[2]/div/section[21]/a[1]")
	...
	public ForSalePage select_City_County() throws InterruptedException
	{
	...
	public ForSalePage select_Prices(String min, String max) throws InterruptedException
	{
		Thread.sleep(3000);
		minBox.sendKeys(min);
		maxBox.sendKeys(max);
	...
	public ForSalePage select_BuildingAge() throws InterruptedException
	{
		Thread.sleep(5000);
